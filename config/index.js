...
const config = {
  ...
  paths: {
    emailConfirmationSuccessPath: 'https://asthmapal.co/utils/profile/success/index.html',
    emailConfirmationFailurePath: 'https://asthmapal.co/utils/profile/fail/index.html',
